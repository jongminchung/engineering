...
import {
    type CoffeeShopService,
    CoffeeType,
    type CreateOrderServerInput,
    type CreateOrderServerOutput,
    type GetMenuServerInput,
    type GetMenuServerOutput,
    type GetOrderServerInput,
    type GetOrderServerOutput,
    OrderNotFound,
    OrderStatus,
...
export class CoffeeShop implements CoffeeShopService<CoffeeShopContext> {
    ...
    async GetMenu(
        _input: GetMenuServerInput,
        _context: CoffeeShopContext,
