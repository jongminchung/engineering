 ...
 *
 * <ul>
 *   <li>{@code push} - 요소를 스택의 맨 위에 추가
 *   <li>{@code pop} - 스택의 맨 위 요소를 제거하고 반환
 *   <li>{@code peek} - 스택의 맨 위 요소를 반환 (제거하지 않음)
 * </ul>
 *
 * <h2>Queue 연산</h2>
 *
 * <ul>
 *   <li>{@code offer} - 큐의 끝에 요소 추가
 *   <li>{@code poll} - 큐의 맨 앞 요소를 제거하고 반환
 *   <li>{@code peek} - 큐의 맨 앞 요소를 반환 (제거하지 않음)
 * </ul>
 *
 * <p>Java Queue는 bounded queue(용량 제한 큐)와 unbounded queue(무제한 큐) 모두를 추상화합니다.
 *
 * <ul>
 *   <li>예외 기반 연산: add, remove, element
 *   <li>상태 기반 연산: offer, poll, peek
 * </ul>
 *
 * <h2>Deque 연산</h2>
 *
 * <ul>
 *   <li>{@code offerFirst} - 덱의 앞에 요소 추가
 *   <li>{@code offerLast} - 덱의 끝에 요소 추가
 *   <li>{@code pollFirst} - 덱의 앞 요소를 제거하고 반환
 *   <li>{@code pollLast} - 덱의 끝 요소를 제거하고 반환
 *   <li>{@code peekFirst} - 덱의 앞 요소를 반환 (제거하지 않음)
 *   <li>{@code peekLast} - 덱의 끝 요소를 반환 (제거하지 않음)
 * </ul>
 */
